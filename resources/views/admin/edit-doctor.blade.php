                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                      ...
                      <div class="form-group form-group-default">
                        <input name="first_name" type="text" class="form-control" placeholder="Ism" value="{{ $doctor->first_name}}"/>
                        
                      </div>
                <label class="mb-3"><b>familiya</b></label>
              <div class="form-group form-group-default">
            <input  name="last_name" type="text" class="form-control" placeholder="Familiya" value="{{ $doctor->last_name }}"/>
                        
               </div>
               <label class="mb-3"><b>Mutahasislik</b></label>
                      <div class="row g-3">
                        <div class="col-12 col-sm-6">
                          <select class="form-select border-0" style="height: 55px;" name="profession_id">
                              <option value="{{ old('profession_id', $doctor->profession_id) }}" selected>{{ $doctor->profession->name}}</option>
