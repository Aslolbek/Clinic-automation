        ...
        <div class="page-inner">
          ...
          <div class="row">
            <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                      ...
                      <div class="form-group form-group-default">
                        <input name="first_name" type="text" class="form-control" placeholder="Ism" value="{{old('first_name')}}"/>
                        @error('first_name')
                        <p class="alert alert-danger">{{ $message }}</p>
                        @enderror
                      </div>
              ...
              <div class="form-group form-group-default">
            <input  name="last_name" type="text" class="form-control" placeholder="Familiya" value="{{old('last_name')}}"/>
                        @error('last_name')
                        <p class="alert alert-danger">{{ $message }}</p>
                        @enderror
               </div>
