            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid rounded w-75 align-self-end" src="{{ asset('storage/' . $doctor->photo) }}"
                            alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p>{{ $doctor->about }}</p><i class="far fa-check-circle text-primary me-3"></i>Sifatli sog'liqni
                    saqlash</p>
                    ...
                    @auth
                        <a class="btn btn-primary rounded-pill py-3 px-5 mt-3"
                            href="{{ route('appointments.index') }}">Qabul</a>
                    @else
                        <a class="btn btn-primary rounded-pill py-3 px-5 mt-3" href="{{ route('login') }}">Qabul uchun
                            tizimga kiring</a>
