            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <h4 class="mb-3">{{ $profession->name }}</h4>
                        <p class="mb-4">{{ $profession->about }}</p>
                        <a class="btn" href="{{ route('professions.show', parameters: ['profession' => $profession->id]) }}"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
